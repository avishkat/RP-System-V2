...
<html>
	<head>
		...
		<script src="{{url('public/frontend/js/jquery.dropotron.min.js')}}"></script>
		<script src="{{url('public/frontend/js/skel.min.js')}}"></script>
		<script src="{{url('public/frontend/js/skel-layers.min.js')}}"></script>
		<script src="{{url('public/frontend/js/init.js')}}"></script>
		<noscript>
			<link rel="stylesheet" href="{{url('public/frontend/css/skel.css')}}" />
			<link rel="stylesheet" href="{{url('public/frontend/css/style.css')}}" />
			<link rel="stylesheet" href="{{url('public/frontend/css/style-desktop.css')}}" />
		</noscript>
									...
									<div>
										<div class="row">
											<div class="3u">
												...
												<!-- Feature -->
													<section class="box feature">
														<a href="#" class="image featured"><img src="{{url('public/frontend/images/pic01.jpg')}}" alt="" /></a>
											...
											<div class="3u">
												...
												<!-- Feature -->
													<section class="box feature">
														<a href="#" class="image featured"><img src="{{url('public/frontend/images/pic02.jpg')}}" alt="" /></a>
											...
											<div class="3u">
												...
												<!-- Feature -->
													<section class="box feature">
														<a href="#" class="image featured"><img src="{{url('public/frontend/images/pic03.jpg')}}" alt="" /></a>
											...
											<div class="3u">
												...
												<!-- Feature -->
													<section class="box feature">
														<a href="#" class="image featured"><img src="{{url('public/frontend/images/pic04.jpg')}}" alt="" /></a>
